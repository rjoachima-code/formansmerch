...
export default [
    {
        ...
        languageOptions: {
            globals: {
                ...
                switchTab: "readonly", populateSubAreas: "readonly", submitAudit: "readonly", logSOP: "readonly", exportCSV: "readonly", showOfflineModal: "readonly", downloadApp: "readonly"
            }
        },
        rules: {
            "no-undef": "error",
            "no-unused-vars": ["error", { "varsIgnorePattern": "^(switchTab|populateSubAreas|submitAudit|logSOP|exportCSV|showOfflineModal|downloadApp)$" }]
        }
    }
];